...
Put the files day.csv, hour.csv, and the notebook together in one folder.
Launch the notebook either in Jupyter or VSCode.
Run all the cells sequentially.
Check the results of the final model evaluation.
6. Output
